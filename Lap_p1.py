...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun  9 12:17:09 2022
...
cols = ['Company', 'TypeName', 'Cpu_brand', 'Gpu_brand', 'os']

from sklearn.preprocessing import OneHotEncoder
ohe = OneHotEncoder()

pd.DataFrame(ohe.fit_transform(laptop.iloc[:, [0,1,9,14,15]]).toarray())

laptop = pd.get_dummies(laptop, columns = cols)
...
import pickle
laptop.to_csv("df1.csv", index=False)
