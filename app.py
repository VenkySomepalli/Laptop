...
df = pd.read_csv("/home/venky/Desktop/Datascience_360/Laptop_Price_Project/df1.csv")
pipe = pickle.load(open("/home/venky/Desktop/Datascience_360/Laptop_Price_Project/pipe.pkl", "rb"))
...
memory = st.selectbox('Memory(in GB)',[0,128,256,512,1024])
